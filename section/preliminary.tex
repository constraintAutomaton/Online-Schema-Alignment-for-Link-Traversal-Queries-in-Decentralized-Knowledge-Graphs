...
The query processing start by dereferencing~\footnote{By dereferencing we mean performing an \glsentryshort{http} GET on an \gls{iri}} the initial links and inserting the \gls{kg} from those resources inside the internal knowledge base.
