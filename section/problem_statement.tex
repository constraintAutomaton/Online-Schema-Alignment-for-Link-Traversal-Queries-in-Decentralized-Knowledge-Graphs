...
Some of these inconsistencies may appear trivial, such as, the use of both \gls{https} and \gls{http} vocabularies, yet they still require query adaptations, since the query issuer often intends to treat both vocabularies as equivalent.
