...
Both our demonstration~\footnote{\url{https://github.com/onlineSchemaAlignmentLTQP/demonstration}} and implementation~\footnote{\url{https://www.npmjs.com/package/query-sparql-link-traversal-solid-schema-alignment}} are open source and publicly available.
...
The demonstrator is a web-based application that allows users to execute either the proposed benchmark queries or arbitrary custom queries.
