...
For rule processing, we define $AR_s$ as the set of mappings between subwebs $S$ and schema alignment rules $R$ at step $s$.
We consider that a step is the aquisition of a new \gls{kg} by the dereferencing of an \gls{iri}.
