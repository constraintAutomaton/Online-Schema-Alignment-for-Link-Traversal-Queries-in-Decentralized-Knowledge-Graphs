...
In this work, we draw on the \gls{sssom} specification~\cite{sssom_website, matentzoglu2022simple} to structure and formalize these rules.\footnote{We adopt this approach for simplicity, as the focus of this paper is not on the formatting of the rules but on their discovery and applications.}
...
We define a reachability criterion $c_{sa}$, which dereferences the object term of any triple whose predicate has the \gls{iri} \\ \texttt{semmap:ruleSetLocation}.
