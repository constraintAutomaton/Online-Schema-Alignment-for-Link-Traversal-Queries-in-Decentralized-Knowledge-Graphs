...
An example of the resulting serialization is available online~\footnote{\url{https://onlineschemaalignmentltqp.github.io/vocabulary/example.ttl}} and also in Figure \ref{fig:demo_screenshot}.
