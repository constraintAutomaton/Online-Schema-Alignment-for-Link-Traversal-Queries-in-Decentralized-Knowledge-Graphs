...
\title{Demonstrating Online Schema Alignment for Link Traversal Queries in Decentralized Knowledge Graphs on the Web}
\titlerunning{Online Schema Alignment for Link Traversal Queries in Decentralized Knowledge Graphs}
%
...
%
\institute{Ghent University, Gent Belgium
%\email{\{first name\}.\{last name\}@ugent.be}
}
